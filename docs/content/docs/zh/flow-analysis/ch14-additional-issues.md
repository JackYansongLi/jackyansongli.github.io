...
表面张力和毛细效应可能是微流控系统中的驱动力，因此在微注塑成型的模拟中必须包括表面张力。对于数值模拟，可以使用杨-拉普拉斯方程（Kim等 [201]）来评估由表面张力引起的压降：$ \Delta p = \frac{\sigma}{R_1} + \frac{\sigma}{R_2} $ 其中，σ 是流体的表面张力，R1 和 R2 是流动前沿形状的主曲率半径。
...
其中，$\sigma_1, \sigma_2, \sigma_3$ 是感兴趣点的主残余应力；$n_1, n_2, n_3$ 是与主应力方向相关的材料折射率；$\sigma_{11}, \sigma_{22}, \sigma_{33}, \sigma_{12}, \sigma_{23}, \sigma_{31}$ 是笛卡尔坐标系下总应力张量的分量，$C_B$ 是应力-光学系数。
